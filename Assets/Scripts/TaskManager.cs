...
public class TaskManager : MonoBehaviour
{
    ...
    private void GenerateReport()
    {
        ...
        {
            logLines += userId + "," + interactionType + "," + taskLog.GetObjectName() + "," + taskLog.GetStartTimestamp().ToString(CultureInfo.InvariantCulture) + "," + taskLog.GetEndTimestamp().ToString(CultureInfo.InvariantCulture) + "," + taskLog.GetErrorCount() + "\n";
        }
